package com.marcos.sample.github.apijpa.specification.controller;
...
import com.marcos.sample.github.apijpa.specification.model.Droid;
import com.marcos.sample.github.apijpa.specification.model.DroidSpecification;
import com.marcos.sample.github.apijpa.specification.repository.DroidRepository;
...
public class DroidController {
	...
	@ResponseStatus(code = HttpStatus.OK)
	public Slice<Droid> findDroidByName(@ParameterObject Pageable pageable, @PathVariable("name") String name) {
	...
	@ResponseStatus(code = HttpStatus.OK)
	public Slice<Droid> findDroidLikeDescription(@ParameterObject Pageable pageable, @PathVariable("function") String function) {
	...
	@ResponseStatus(code = HttpStatus.OK)
	public Slice<Droid> findDroidBetweenHeight(@ParameterObject Pageable pageable, @RequestHeader(name = "from") double from,
	...
	@ResponseStatus(code = HttpStatus.OK)
	public Slice<Droid> findDroidExists(@ParameterObject Pageable pageable, @PathVariable("height") double height) {
